...
## Нет связи с производителями

Проект является независимым и никак не связан с Hybertone, DBL, DBLtek, DBLTEK
или любым связанным производителем. Он не одобрен, не спонсирован и не
поддерживается этими компаниями. Названия продуктов и компаний используются
только для указания аппаратной/протокольной совместимости. Все товарные знаки
принадлежат их владельцам.

Описание протокола и реализация эмулятора являются оригинальным независимым
исследованием автора для целей совместимости. Это не vendor documentation, не
vendor-authorized source code и не vendor-supported product.
